...
questions_list = [] 
questions_list.append(Question('Какого цвета нет на флаге Италии?' , 'Синий' , 'Зелёный' , 'Белый' , 'Красный'))
questions_list.append(Question('Что такое анатидаефобия?' , 'Боязнь уток' , 'Боязнь одиночества' , 'Боязнь хомяков' , 'Боязнь ёжиков'))
questions_list.append(Question('Государственный язык Италии:' , 'Итальянский' , 'Украинский' , 'Китайский' , 'Японский'))
questions_list.append(Question('Государственный язык Англии:' , 'Английский', 'Португальский', 'Американский', 'Испанский'))
questions_list.append(Question('Государственный язык Германии:', 'Другой ответ' , 'Германский' , 'Русский' , 'Английский'))
questions_list.append(Question('Государственный язык России:' , 'Русский' , 'Российский' , 'Итальянский' , 'Белорусский'))
